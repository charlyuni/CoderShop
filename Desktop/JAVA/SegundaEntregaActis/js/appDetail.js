...
const btnAction = e => {
    if (e.target.classList.contains('btn-info')) {
        ...
        cantidadPedida =  parseInt(document.getElementById("cantidadProductos").textContent )+ 1 ;
        document.getElementById("cantidadProductos").textContent = cantidadPedida
        
    }

    if (e.target.classList.contains('btn-danger')) {
        cantidadPedida > 1 ? cantidadPedida =  parseInt(document.getElementById("cantidadProductos").textContent ) - 1  :cantidadPedida = 0;
        document.getElementById("cantidadProductos").textContent = cantidadPedida
    }
...
const setCarrito = objeto => {
    ...
    const producto = {
        ...
        cantidad: document.getElementById("cantidadProductos").textContent
    }
